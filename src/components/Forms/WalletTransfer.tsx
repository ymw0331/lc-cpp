...
import TransferConfirmationDialog from '../Dialogs/TransferConfirmation';
...
const WalletTransfer = ({ sourceAmount, sourceIcon, currencies, onTransfer }: WalletTransferProps) => {
