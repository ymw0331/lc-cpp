...
const Header = (props: {
  ...
  return (
    <header className="sticky top-0 z-999 flex w-full px-2 sm:px-4 py-2 sm:py-4 bg-whiten dark:bg-boxdark dark:drop-shadow-none">
      <div className="flex w-full items-center justify-between rounded-xl px-2 sm:px-4 py-2 shadow-2 md:px-6 2xl:px-11 bg-white dark:bg-boxdark-2">
        ...
        <div className="flex items-center gap-2 sm:gap-3 2xsm:gap-7">
          ...
          <ul className="flex items-center gap-1 sm:gap-2 2xsm:gap-4">
          ...
          {/* User Dropdown - Always visible but simplified on mobile */}
          <DropdownUser />
        </div>
      </div>
    </header>
