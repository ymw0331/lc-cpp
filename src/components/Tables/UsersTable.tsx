            ...
            <div className="space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        ...
                        >
                            <option value="all">{t("usersTable.allMarkets")}</option>
...
const UsersTable = ({ users }: UsersTableProps) => {
    ...
    const filteredUsers = users.filter((user) => {
        ...
        const matchMarket =
            filterOptions.market === "all" ? true : user.keyMarket === filterOptions.market;
        const matchRanking =
        ...
        if (filterOptions.dateRange.from || filterOptions.dateRange.to) {
            ...
            if (filterOptions.dateRange.from) {
                matchDate =
                    matchDate && userDate >= new Date(filterOptions.dateRange.from);
            }
            if (filterOptions.dateRange.to) {
                matchDate =
                    matchDate && userDate <= new Date(filterOptions.dateRange.to);
            }
        }
                    ...
                    <table className="w-full table-auto">
                        <thead>
                            <tr className="bg-black text-white">
                                ...
                                <th className="py-4 px-4 text-left font-medium">
                                    {t("usersTable.keyMarket")}
                                </th>
                                <th className="py-4 px-4 text-left font-medium">
                                    {t("usersTable.joinedSince")}
                                </th>
                                <th className="py-4 px-4 text-left font-medium">
                                    {t("usersTable.lastActive")}
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            {filteredUsers.map((user, index) => (
                                <tr
                                    ...
                                    className={`
                                        ...
                                        border-b border-stroke dark:border-strokedark ${index % 2 === 0
                                            ? "bg-white dark:bg-boxdark"
                                            : "bg-gray-1 dark:bg-meta-4/30"
                                        }`}
                                >
