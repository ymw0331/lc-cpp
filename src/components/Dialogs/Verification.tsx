...
export const VerificationDialog = ({
    ...
    const messages = {
        email: {
            ...
            description: `To update your email address, we need to verify your identity. An OTP (One-Time Password) has been sent to your registered phone number ending in ${contactDetail}. Please enter code to proceed.`,
        },
        phone: {
            title: "Phone Verification",
            description: `To update your contact number, we need to verify your identity. An OTP (One-Time Password) has been sent to your registered email. Please enter code to proceed.`,
        },
    };
