...
export const metadata: Metadata = {
  title: "Sign Up | Lookcard Admin Portal",
  description: "Create your Lookcard Admin Portal account to manage your business, monitor performance, and streamline operations effectively.",
  // other metadata
};
