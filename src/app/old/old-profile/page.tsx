...
export const metadata: Metadata = {
  title: "Profile | Lookcard Admin Portal",
  description: "Manage your profile settings and preferences in the Lookcard Admin Portal. Keep your information up-to-date and personalize your experience.",
};
